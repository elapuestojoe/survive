...
assets['Default'] = [
    ...
    ('/Users/carlossebastianloredogomez/survive/resources', '.', 0),
]

assets['shared'] = [
    ('/Users/carlossebastianloredogomez/survive/resources/quicklua/dbg.lua', 'quicklua/dbg.lua', 0),
    ('/Users/carlossebastianloredogomez/survive/resources/quicklua/openquick.lua', 'quicklua/openquick.lua', 0),
    ('/Users/carlossebastianloredogomez/survive/resources/quicklua/QConfig.lua', 'quicklua/QConfig.lua', 0),
    ('/Users/carlossebastianloredogomez/survive/resources/config.lua', 'config.lua', 0),
    ('/Users/carlossebastianloredogomez/survive/resources/fonts', 'fonts', 0),
]
...
assets['precompiledLua'] = [
    ...
    ('/Users/carlossebastianloredogomez/survive/resources/config.lua', 'config.lua', 0),
    ('/Users/carlossebastianloredogomez/survive/resources/fonts', 'fonts', 0),
    ('/Users/carlossebastianloredogomez/survive/resources-precompiled', '.', 0),
]
...
assets['optimisedLua'] = [
    ...
    ('/Users/carlossebastianloredogomez/survive/resources/config.lua', 'config.lua', 0),
    ('/Users/carlossebastianloredogomez/survive/resources/fonts', 'fonts', 0),
    ('/Users/carlossebastianloredogomez/survive/resources-concatenated', '.', 0),
]
...
class DefaultConfig(DeployConfig):
    ...
    long_caption = 'JUANPI'
    version = [0, 0, 1]
    config = ['/Users/carlossebastianloredogomez/survive/resources/common.icf', '/Users/carlossebastianloredogomez/survive/resources/app.icf']
    data_dir = '/Users/carlossebastianloredogomez/survive/resources'
    mkb_dir = '/Users/carlossebastianloredogomez/survive'
    iphone_link_lib = ['s3eAmazonAds', 's3eFacebook', 's3eWebView', 's3eIOSAppStoreBilling', 'Flurry_6.5.0', 'FlurryAds_6.5.0', 's3eFlurry']
    osx_ext_dll = ['/Applications/Marmalade.app/Contents/extensions/s3eWebView/lib/osx/libs3eWebView.dylib']
    wp81_extra_pri = []
    ws8_ext_capabilities = []
    ws8_ext_native_only_dll = []
    win10_ext_uap_capabilities = []
    win10_ext_native_dll = ['/Applications/Marmalade.app/Contents/extensions/s3eFacebook/lib/win10/s3eFacebookExtension.dll', '/Applications/Marmalade.app/Contents/extensions/s3eWebView/lib/win10/s3eWebViewExtension.dll']
    ...
    win32_ext_dll = ['/Applications/Marmalade.app/Contents/extensions/s3eWebView/lib/win32/s3eWebView.dll']
    win10_ext_sdk_ref = []
    wp8_ext_capabilities = []
    ws8_extra_res = ['/Applications/Marmalade.app/Contents/extensions/s3eFacebook/third-party/facebook_ws8_lib/Facebook_Client', '/Applications/Marmalade.app/Contents/extensions/s3eWebView/source/ws8/WebViewModal.xaml=>']
    ...
    iphone_link_libdir = ['/Applications/Marmalade.app/Contents/extensions/s3eAmazonAds/lib/iphone', '/Applications/Marmalade.app/Contents/extensions/s3eFacebook/lib/iphone', '/Applications/Marmalade.app/Contents/extensions/s3eWebView/lib/iphone', '/Applications/Marmalade.app/Contents/extensions/s3eIOSAppStoreBilling/lib/iphone', '/Applications/Marmalade.app/Contents/platform_libs/iphone/flurry-iphone-sdk/libs', '/Applications/Marmalade.app/Contents/extensions/s3eFlurry/lib/iphone']
    ...
    win10_extra_res = ['/Applications/Marmalade.app/Contents/extensions/s3eFacebook/third-party/facebook_win10_lib/Facebook.Client', '/Applications/Marmalade.app/Contents/extensions/s3eWebView/lib/win10/WebViewModal.xbf=>']
    ...
    ws81_extra_pri = []
    android_external_jars = ['/Applications/Marmalade.app/Contents/platform_libs/android/amazon-ads-android-sdk/third_party/lib/amazon-ads-5.5.149.jar', '/Applications/Marmalade.app/Contents/extensions/s3eAmazonAds/lib/android/s3eAmazonAds.jar', '/Applications/Marmalade.app/Contents/platform_libs/android/android-support-v4/android-support-v4.jar', '/Applications/Marmalade.app/Contents/platform_libs/android/bolts-android/bolts-android-1.1.2.jar', '/Applications/Marmalade.app/Contents/platform_libs/android/marmalade-facebook-android-sdk/lib/android/marmalade-facebook-android-sdk-3.22.0.jar', '/Applications/Marmalade.app/Contents/extensions/s3eFacebook/lib/android/s3eFacebook.jar', '/Applications/Marmalade.app/Contents/extensions/s3eWebView/lib/android/s3eWebView.jar', '/Applications/Marmalade.app/Contents/platform_libs/android/amazon-in-app-purchasing-android-sdk/third_party/lib/in-app-purchasing-2.0.61.jar', '/Applications/Marmalade.app/Contents/extensions/s3eAmazonInAppPurchasing/lib/android/s3eAmazonInAppPurchasing.jar', '/Applications/Marmalade.app/Contents/extensions/s3eAndroidMarketBilling/lib/android/s3eAndroidMarketBilling.jar', '/Applications/Marmalade.app/Contents/extensions/s3eAndroidGooglePlayBilling/lib/android/s3eAndroidGooglePlayBilling.jar', '/Applications/Marmalade.app/Contents/extensions/s3eSamsungInAppPurchasing/lib/android/s3eSamsungInAppPurchasing.jar', '/Applications/Marmalade.app/Contents/extensions/s3eSamsungInAppPurchasing/lib/android/iap2.0_lib.jar', '/Applications/Marmalade.app/Contents/platform_libs/android/flurry-android-sdk/lib/FlurryAds-5.5.0.jar', '/Applications/Marmalade.app/Contents/platform_libs/android/flurry-android-sdk/lib/FlurryAnalytics-5.5.0.jar', '/Applications/Marmalade.app/Contents/extensions/s3eFlurry/lib/android/s3eFlurry.jar']
    win8_winrt_extra_res = []
    wp81_ext_sdk_manifest_part = []
    wp81_extra_res = ['/Applications/Marmalade.app/Contents/extensions/s3eFacebook/third-party/facebook_wp81_lib/Facebook.Client', '/Applications/Marmalade.app/Contents/extensions/s3eWebView/source/ws8/WebViewModal.xaml=>']
    ...
    win10_ext_managed_dll = ['/Applications/Marmalade.app/Contents/extensions/s3eFacebook/lib/win10/s3eFacebookManaged.winmd', '/Applications/Marmalade.app/Contents/extensions/s3eFacebook/third-party/facebook_win10_lib/Facebook.Client.dll', '/Applications/Marmalade.app/Contents/extensions/s3eFacebook/third-party/facebook_win10_lib/Facebook.dll', '/Applications/Marmalade.app/Contents/extensions/s3eWebView/lib/win10/s3eWebViewManaged.winmd']
    ...
    iphone_link_opts = ['-F/Applications/Marmalade.app/Contents/platform_libs/iphone/amazon-ads-ios-sdk/third_party/Ads -framework AmazonAd', '-weak_framework AdSupport -weak_framework CoreLocation -weak_framework SystemConfiguration', '-weak_framework CoreTelephony -weak_framework MediaPlayer', '-weak_framework EventKit -weak_framework EventKitUI', '-F/Applications/Marmalade.app/Contents/platform_libs/iphone/marmalade-facebook-iphone-sdk -framework FBAudienceNetwork -framework FacebookSDK', '-weak_framework UIKit -weak_framework Foundation -weak_framework CoreGraphics -weak_framework Social', '-weak_framework MediaPlayer -weak_framework Security -weak_framework AdSupport -weak_framework CoreGraphics -weak_framework Foundation -weak_framework StoreKit -weak_framework SystemConfiguration -weak_framework UIKit', '-framework SystemConfiguration -framework Security']
    ws81_ext_sdk_ref = []
